...
# 导入新训练的模型参数
ckpt_filename = './train_model/model.ckpt-4000'   # 注意xxx代表的数字是否和文件夹下的一致
...
# 主流程函数
def process_image(img, select_threshold=0.3, nms_threshold=.01, net_shape=(300, 300)):
...
video_path = 'C:/Users/asus/Desktop/testimage/avi/test_real1.mp4'
save_path = 'C:/Users/asus/Desktop/testimage/实验视频/yolo_v5_real1.avi'
image_names = sorted(os.listdir(path))
# 文件夹中的第几张图，-1代表最后一张
cap = cv2.VideoCapture(video_path)
size = (int(cap.get(cv2.CAP_PROP_FRAME_WIDTH)), int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT)))
#videoWrite = cv2.VideoWriter(save_path, cv2.VideoWriter_fourcc('I', '4', '2', '0'), 60, size)
